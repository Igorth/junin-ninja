...
public class CopyPlayerMovement : MonoBehaviour
{
    ...
    void Movement()
    {
        ...
        /*
         * this can move your character +1 or -1, pressing the direction
        ...
        */
        ...
        if (h > 0)
        {
            // Time.deltaTime - smooth the movement
            tempPos.x += movementSpeed * Time.deltaTime;
            sr.flipX = false;

            // The face of the character will show to right
        ...
        else if (h < 0)
        {
            ...
            // The face of the character will show to left
            //tempScale.x = -Mathf.Abs(tempScale.x);
            playerAnim.Play(runAnimatorName);
        }
        if (h == 0)
